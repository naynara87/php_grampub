...
<!--begin::Header-->
										...
										<div class="navi navi-spacer-x-0 pt-5">
											...
											<div class="navi-footer px-8 py-5">
												<a href="custom/pages/login/login-1.html" target="_blank" class="btn btn-light-primary font-weight-bold">Sign Out</a>
												<a href="custom/pages/pricing/pricing-2.html" target="_blank" class="btn btn-clean font-weight-bold">Upgrade Plan</a>
											</div>
