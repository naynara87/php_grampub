<div class="modal fade bg-dark-o-50" id="shareMove" tabindex="-1" aria-labelledby="shareSelect" aria-modal="true"
	role="dialog">
	...
	<div class="modal-content overflow-hidden">
			...
			<form>
				<div class="form-group row mb-0">
					<label class="col-md-3 col-form-label font-weight-bold">이동할 폴더 선택</label>
					<div class="col-md-9">
		...
		<div class="modal-footer text-center py-2">
			...
			<a href="?cms=/lesson/interaction" class="btn btn-info font-weight-bold">저장</a>
		</div>
	</div>
        </div>	
